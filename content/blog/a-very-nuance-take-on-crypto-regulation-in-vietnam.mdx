...
_[↑ Link to Facebook post](https://www.facebook.com/share/p/1G7ydJixz2/)_

There is a new [Global On-chain Economy Alliance](https://www.goealliance.org/) organization that will set up at the IFC in Ho Chi Minh City; both KyberSwap and Sky Mavis are founding members, which I hope they would advocate for Ethereum builders but only time could tell.

![Image](/blog-images/thumbnails/a-very-nuance-take-on-crypto-regulation-in-vietnam3.jpeg)
_[↑ Link to blog post](https://www.goealliance.org/blog/goe-alliance-meetup-ecosystem-2026-roadmap)_

Honestly, I haven't been able to find any organizations worthy enough for me to support publicly at the moment. I do run my own initiatives [DeFi.vn](https://www.defi.vn) and [Weth.vn](https://www.weth.vn) but they are social media driven, with no major backings behind.
